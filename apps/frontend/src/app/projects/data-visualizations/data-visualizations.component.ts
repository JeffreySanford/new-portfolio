...
@Component({
  ...
  styleUrl: './data-visualizations.component.scss'
})
export class DataVisualizationsComponent implements OnInit {
  charts = [
    { 
      ...
      color: 'lightblue', // Bright color for contrast
      data: [
    ...
    { 
      ...
      color: 'lightgreen', // Bright color for contrast
      data: [
    ...
    { 
      ...
      color: 'lightcoral', // Bright color for contrast
      data: [
  ...
  ngOnInit(): void {
    console.log('Tile container initialized');
  }
