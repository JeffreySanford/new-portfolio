...
export class PeasantKitchenComponent implements OnInit, OnDestroy {
  ...
  showRecipe(recipe: Recipe) {
    ...
    this.recipe = recipe;
    this.router.navigate(['/peasant-kitchen', recipe.url]);
  }
}
